...
import { BASE_VERSION_DATABASE_QUERY, FIX_SUGGESTION_VERSION_DATABASE_QUERY, PRE_PUBLISH_VERSION_DATABASE_QUERY, SUGGESTION_VERSION_DATABASE_QUERY,  REVIEW_VERSION_DATABASE_QUERY } from 'src/environments/constants';
...
const LATEST_VERSION: string = REVIEW_VERSION;
